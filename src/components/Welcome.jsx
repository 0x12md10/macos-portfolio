...
const Welcome = () => {
    ...
    useGSAP(()=> {
        const titleCleaneUp = setupTextHover(titleRef.current , 'title');
        const subtitleCleaneUp = setupTextHover(subtitleRef.current, 'subtitle');
    ...
    return (
        <section id="welcome">
            <p ref={subtitleRef}>{
                renderText("Hey, I'm Abishek! Welcome to my","text-3xl font-georama",100)
            }</p>
